...
**** INPROGRESS Reviewforge improvement TODO list [24/26]
***** TODO Collect good review comment
***** TODO Collect individual review efforts
...
# select id from reviews_reviewrequest where time_added > '2010-06-24 00:00:00' order by id;

Get total review comments (defects, accepted, major):
# select count(id)
#commenttype_id, commentstate_id, commentseverity_id 
from reviews_comment 
where review_request_id in (select id from reviews_reviewrequest where time_added > '2010-06-24 00:00:00') 
...
**** Need to follow up in whole team [0/2]
***** TODO Add reviewer in the svn commit log
***** TODO Send out weekly/monthly review?
...
**** INPROGRESS Installation intergration

***** TODO add GUI error restart DB page and action

***** TODO test init database

***** TODO remove db_util.rb
...
*** [#A] Installation restore procedure
