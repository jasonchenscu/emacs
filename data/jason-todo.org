...
**** DONE 1.4.1 bug fixing
	 CLOSED: [2010-11-24 Wed 11:07]
**** TODO slony event pending fix - add slon service restart after ntp configured
** Time management
*** My timechart 
**** From 6-28 To 9-3
***** Detail tasks
...
**** DONE Reviewforge improvement TODO list [26/28]
...
***** INPROGRESS Leverage QA in reviewboard, like bugzilla integration
***** INPROGRESS Start design review in your small project and practice, try to formalize the process
...
*** DONE Send out email about response to review comment
	 CLOSED: [2010-11-07 Sun 21:29]
*** TODO Update slony wiki page on node replacement testing negative cases
...
11/30 att delete UID case - 0.5 hour
