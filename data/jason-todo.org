...
**** INPROGRESS Reviewforge improvement TODO list [18/24]
***** INPROGRESS Prepare guidelines for team members on use new ReviewBoard
***** TODO Add maintainance work in ReviewBoard host (cronjob to backup database, regenerate index)
***** TODO Remove "Analyze by SCA" and meeting review during create review request
***** TODO Remove feature?
***** TODO Idenfity weekly review metrics KPI
***** TODO Hold kickoff meeting to introduce ReviewBoard
...
** Atmos 1.2.7 cycle [1/3]
*** INPROGRESS Setup MaaS similar testbed and try to reproduce random subtenant creation issues
*** DONE fix pgdbsetup dup record - wait Yubo response
	 CLOSED: [2010-04-20 Tue 11:23]
*** INPROGRESS [#A] eBay migration DC planning
**** Planning
...
**** Follow up in 1.2.7 [1/3]

***** TODO confirm whether MDLS_List updated need to reconfigure MDLS service
***** TODO confirm detail changes for below config items
...
**** Slony follow up
think about total solution on slony failure scenario, like what we will do on handle master failure, how to monitor, more from customer perspective. 
what we can do better for slony than cybercluster for failure scenario?
...
# omreport system version Version Report
