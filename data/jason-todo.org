...
**** INPROGRESS Reviewforge improvement TODO list [25/26]
...
where review_request_id in (select id from reviews_reviewrequest where time_added > '2010-07-18 00:00:00') 
