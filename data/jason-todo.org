...
*** TODO review board review process workflow
*** TODO decouple genprofile for better organise and rereuse code, consider ip change and reconfiguration together.
...
** Atmos 1.4 cycle
*** Task module redesign - sync framework
Design consideration:
1. K.I.S.S
2. Think more in a large scale

*** Postgresql changes
**** TODO initDB -  --no-locale --encoding=EUC_JP
...
*** INPROGRESS Installation restore procedure
...
*** Set up large scale testbed for mgmt DB test
...
** Mgmt DB roadmap TODO list
*** TODO Think about divide db data and log to different disks which we can leverage external DAE disks

*** TODO Prepare testing use cases
Performance:
- Target:
...
Upgrade:
*** TODO Integrate pgdbdump with logcopy
*** TODO Investigate put db log files to SS disks
*** TODO Investigate pgreplicate hold too many connections after a long time
*** TODO Investigate postgresql data size too large after a long time
*** TODO Compare with dump/restore and autovaccum impact to the database size and performance
*** TODO Can we consider add more postgresql nodes to pgcluster to improve availability


** Upgrade develop and check process
...
** Tea session potential topics
1. life lesson learn topics?
...
6. seven habits
7. refine existing module architecture
8. cannot get attraction with too many food if talking about technical topics
9. a series of workshop with some specific topics
10. programming thought, e.g. design pattern, SEDA(Jiang)
11. introduction to Huawei, eBay, IBM quality assure process - by Yubo, Lizhong, Xin, Hongbin
12. Caihua film introduction, weekend books interested
13. team senior people introduct coding experience
14. home introduction, tradition
15. prepare slides and organise all information in twiki
16. tea session feedback collection and post brainstorming
17. review past session experience - session postmortem
18. how to manage bug and maintain?
19. how to collect and organize information?
20. other products introduction - feature, design, architecture analyze
21. invite other team members to hear others opinion
** Atmos 1.3 cycle 
...
** TODO update db wiki about impact areas (files, comments?)
...
** TODO Check whether updateNodeInfo has update clusteruuid in nodes table. Currently if we restart mauicm and db doesn't contain the record, this will cause clusteruuid empty.
** TODO Refine setNodeInfo to two API: addNodeInfo, updateNodeInfo
** TODO Add IPADDR check in postgresql script. 
if eth1 use DHCP get IP, ifcfg-eth1 IPADDR maybe empty and postgresql cannot be initialized
** TODO Refine installation design wiki to latest status
** TODO Config DRAC and auto deployment physical testbed
** TODO Seven habits share session prepare
...
*** Idea list
** Menu for my wife
   CLOCK: [2010-02-07 Sun 00:53]
   CLOCK: [2010-02-07 Sun 00:53]--[2010-02-07 Sun 00:53] =>  0:00
青椒肉丝
蘑菇油菜
西葫芦炒鸡蛋
肉炒茄丝和青椒丝
...
0:00:28 0:00:2 *9* 0:00:31 0u:01:09 
- 0:01:12 :: 
- 0:01:16 :: 
- 0:01:19 :: /0:01:25 0:01:27 0:01/:2 *8 * ,0:01:34 0:01:34 0:01:34 -0:00:24 -0:00:24 -0:00:22 -0:00:21 

=asdf= _asdfaasdf_ a *sdfsdf* *sdfa*
_asdfasdf_ adfas


aaa bbb ccc
* temp
** TODO Attend ming's RCA meeting								  :IMPORTANT:
   DEADLINE: <2010-02-09 Tue> 
- Book a room
- call phone
- take notes
** DONE Try pit  <2010-02-08 13:13>
   CLOSED: [2010-02-08 Mon 13:12]

** TODO Send meeting request for Hang
   DEADLINE: <2010-02-07 Sun>
