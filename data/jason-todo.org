...
**** INPROGRESS start read disk mgmt code
...
**** DONE Reviewforge improvement TODO list [26/26]
...
** TODOLIST [19/25]
*** TODO Prepare code review sharing session
*** TODO Think about how to summarize slony work to Rich
*** TODO Send out email about response to review comment
