...
** TODOLIST
*** TODO bug 10618 get version from conary command
*** TODO review board review process workflow
*** INPROGRESS decouple genprofile for better organise and rereuse code, consider ip change and reconfiguration together.
