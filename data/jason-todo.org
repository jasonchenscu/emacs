...
* Non-project related
** Daily TODO list
*** TODO code review knowledge sharing
*** TODO analyze magic number in the code
*** TODO qpid related document on troubleshooting
*** TODO slony summary slide
*** TODO 
*** 2010-10-25 
**** DONE event pending
...
*** Questions discuss with Rulian
1. If the new fix require big effort but very useful to customer, do we need to cover it or discuss with all other managers to prioritize the tasks?
2. 
...
**** TODO Ask Anne about NTP requirement document
...
**** TODO Add bugzilla custom search to include sustaining related bugs 

**** TODO Add wiki page FAQ about code review and fix branch process 
...
*** TODO Think about how to summarize slony work to Rich
...
** Atmos 1.5 cycle
*** Disk management
**** Learning existing design
***** Questions
1. When in "partition status", why change to "new" when received remove or ioerr event.
2. 

Issues:

1. should not set task status during CmDiskStage::waitAddDiskCb
2. 

** Atmos 1.4 cycle
*** Slony replication for postgres
**** Mgmt expection
...
# mauictl stop
# atmosnetmgr add bond nics=eht1,eth2 mode=1 millmon=100
# dmesg | grep “eth.*PCI”
...
letao 10 yuan: 1079386948537219
